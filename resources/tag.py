...
blp = Blueprint("Tags", __name__, description="Opertions on tags")
...
class TagsInStore(MethodView):
    ...
    def post(self, tag_data, store_id):
        ...
        if TagModel.query.filter(
            ...
            abort(400, message="A tag with that same name already exists in the store")
    ...
    class Tag(MethodView):
        ...
        @blp.alt_response(
            400,
            description="Returned if the tag is assigned to one or more items. In this case, the tag is not delete.",
        )
